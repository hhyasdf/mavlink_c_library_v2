 ...
 */
static inline uint16_t mavlink_msg_boot_pack(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t* msg,
                               uint32_t version)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, group_id, MAVLINK_MSG_ID_BOOT_MIN_LEN, MAVLINK_MSG_ID_BOOT_LEN, MAVLINK_MSG_ID_BOOT_CRC);
}
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_boot_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t group_id, uint8_t chan,
                                   ...
                                   uint32_t version)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_BOOT;
    return mavlink_finalize_message_chan(msg, system_id, component_id, group_id, chan, MAVLINK_MSG_ID_BOOT_MIN_LEN, MAVLINK_MSG_ID_BOOT_LEN, MAVLINK_MSG_ID_BOOT_CRC);
}
 ...
 */
static inline uint16_t mavlink_msg_boot_encode(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t* msg, const mavlink_boot_t* boot)
{
    return mavlink_msg_boot_pack(system_id, component_id, group_id, msg, boot->version);
}
 ...
 * @param boot C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_boot_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t group_id, uint8_t chan, mavlink_message_t* msg, const mavlink_boot_t* boot)
{
    return mavlink_msg_boot_pack_chan(system_id, component_id, group_id, chan, msg, boot->version);
}
