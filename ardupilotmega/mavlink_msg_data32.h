 ...
 */
static inline uint16_t mavlink_msg_data32_pack(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t* msg,
                               uint8_t type, uint8_t len, const uint8_t *data)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, group_id, MAVLINK_MSG_ID_DATA32_MIN_LEN, MAVLINK_MSG_ID_DATA32_LEN, MAVLINK_MSG_ID_DATA32_CRC);
}
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_data32_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t group_id, uint8_t chan,
                                   ...
                                   uint8_t type,uint8_t len,const uint8_t *data)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_DATA32;
    return mavlink_finalize_message_chan(msg, system_id, component_id, group_id, chan, MAVLINK_MSG_ID_DATA32_MIN_LEN, MAVLINK_MSG_ID_DATA32_LEN, MAVLINK_MSG_ID_DATA32_CRC);
}
 ...
 */
static inline uint16_t mavlink_msg_data32_encode(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t* msg, const mavlink_data32_t* data32)
{
    return mavlink_msg_data32_pack(system_id, component_id, group_id, msg, data32->type, data32->len, data32->data);
}
 ...
 * @param data32 C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_data32_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t group_id, uint8_t chan, mavlink_message_t* msg, const mavlink_data32_t* data32)
{
    return mavlink_msg_data32_pack_chan(system_id, component_id, group_id, chan, msg, data32->type, data32->len, data32->data);
}
