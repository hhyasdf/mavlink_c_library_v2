 ...
 */
static inline uint16_t mavlink_msg_data96_pack(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t* msg,
                               uint8_t type, uint8_t len, const uint8_t *data)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, group_id, MAVLINK_MSG_ID_DATA96_MIN_LEN, MAVLINK_MSG_ID_DATA96_LEN, MAVLINK_MSG_ID_DATA96_CRC);
}
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_data96_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t group_id, uint8_t chan,
                                   ...
                                   uint8_t type,uint8_t len,const uint8_t *data)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_DATA96;
    return mavlink_finalize_message_chan(msg, system_id, component_id, group_id, chan, MAVLINK_MSG_ID_DATA96_MIN_LEN, MAVLINK_MSG_ID_DATA96_LEN, MAVLINK_MSG_ID_DATA96_CRC);
}
 ...
 */
static inline uint16_t mavlink_msg_data96_encode(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t* msg, const mavlink_data96_t* data96)
{
    return mavlink_msg_data96_pack(system_id, component_id, group_id, msg, data96->type, data96->len, data96->data);
}
 ...
 * @param data96 C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_data96_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t group_id, uint8_t chan, mavlink_message_t* msg, const mavlink_data96_t* data96)
{
    return mavlink_msg_data96_pack_chan(system_id, component_id, group_id, chan, msg, data96->type, data96->len, data96->data);
}
