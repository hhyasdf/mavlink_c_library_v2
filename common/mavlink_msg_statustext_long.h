 ...
 */
static inline uint16_t mavlink_msg_statustext_long_pack(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t* msg,
                               uint8_t severity, const char *text)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, group_id, MAVLINK_MSG_ID_STATUSTEXT_LONG_MIN_LEN, MAVLINK_MSG_ID_STATUSTEXT_LONG_LEN, MAVLINK_MSG_ID_STATUSTEXT_LONG_CRC);
}
 ...
 * @return length of the message in bytes (excluding serial stream start sign)
 */
static inline uint16_t mavlink_msg_statustext_long_pack_chan(uint8_t system_id, uint8_t component_id, uint8_t group_id, uint8_t chan,
                                   ...
                                   uint8_t severity,const char *text)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_STATUSTEXT_LONG;
    return mavlink_finalize_message_chan(msg, system_id, component_id, group_id, chan, MAVLINK_MSG_ID_STATUSTEXT_LONG_MIN_LEN, MAVLINK_MSG_ID_STATUSTEXT_LONG_LEN, MAVLINK_MSG_ID_STATUSTEXT_LONG_CRC);
}
 ...
 */
static inline uint16_t mavlink_msg_statustext_long_encode(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t* msg, const mavlink_statustext_long_t* statustext_long)
{
    return mavlink_msg_statustext_long_pack(system_id, component_id, group_id, msg, statustext_long->severity, statustext_long->text);
}
 ...
 * @param statustext_long C-struct to read the message contents from
 */
static inline uint16_t mavlink_msg_statustext_long_encode_chan(uint8_t system_id, uint8_t component_id, uint8_t group_id, uint8_t chan, mavlink_message_t* msg, const mavlink_statustext_long_t* statustext_long)
{
    return mavlink_msg_statustext_long_pack_chan(system_id, component_id, group_id, chan, msg, statustext_long->severity, statustext_long->text);
}
