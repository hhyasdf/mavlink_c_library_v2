...
static void mavlink_test_all(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_matrixpilot(system_id, component_id, group_id, last_msg);
}
#endif
...
static void mavlink_test_flexifunction_set(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_msg_flexifunction_set_encode(system_id, component_id, group_id, &msg, &packet1);
    mavlink_msg_flexifunction_set_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flexifunction_set_pack(system_id, component_id, group_id, &msg , packet1.target_system , packet1.target_component );
    mavlink_msg_flexifunction_set_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flexifunction_set_pack_chan(system_id, component_id, group_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component );
    mavlink_msg_flexifunction_set_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_flexifunction_read_req(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
...
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flexifunction_read_req_encode(system_id, component_id, group_id, &msg, &packet1);
    mavlink_msg_flexifunction_read_req_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flexifunction_read_req_pack(system_id, component_id, group_id, &msg , packet1.target_system , packet1.target_component , packet1.read_req_type , packet1.data_index );
    mavlink_msg_flexifunction_read_req_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flexifunction_read_req_pack_chan(system_id, component_id, group_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component , packet1.read_req_type , packet1.data_index );
    mavlink_msg_flexifunction_read_req_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_flexifunction_buffer_function(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
...
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flexifunction_buffer_function_encode(system_id, component_id, group_id, &msg, &packet1);
    mavlink_msg_flexifunction_buffer_function_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flexifunction_buffer_function_pack(system_id, component_id, group_id, &msg , packet1.target_system , packet1.target_component , packet1.func_index , packet1.func_count , packet1.data_address , packet1.data_size , packet1.data );
    mavlink_msg_flexifunction_buffer_function_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flexifunction_buffer_function_pack_chan(system_id, component_id, group_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component , packet1.func_index , packet1.func_count , packet1.data_address , packet1.data_size , packet1.data );
    mavlink_msg_flexifunction_buffer_function_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_flexifunction_buffer_function_ack(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
...
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flexifunction_buffer_function_ack_encode(system_id, component_id, group_id, &msg, &packet1);
    mavlink_msg_flexifunction_buffer_function_ack_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flexifunction_buffer_function_ack_pack(system_id, component_id, group_id, &msg , packet1.target_system , packet1.target_component , packet1.func_index , packet1.result );
    mavlink_msg_flexifunction_buffer_function_ack_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flexifunction_buffer_function_ack_pack_chan(system_id, component_id, group_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component , packet1.func_index , packet1.result );
    mavlink_msg_flexifunction_buffer_function_ack_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_flexifunction_directory(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
...
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flexifunction_directory_encode(system_id, component_id, group_id, &msg, &packet1);
    mavlink_msg_flexifunction_directory_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flexifunction_directory_pack(system_id, component_id, group_id, &msg , packet1.target_system , packet1.target_component , packet1.directory_type , packet1.start_index , packet1.count , packet1.directory_data );
    mavlink_msg_flexifunction_directory_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flexifunction_directory_pack_chan(system_id, component_id, group_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component , packet1.directory_type , packet1.start_index , packet1.count , packet1.directory_data );
    mavlink_msg_flexifunction_directory_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_flexifunction_directory_ack(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
...
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flexifunction_directory_ack_encode(system_id, component_id, group_id, &msg, &packet1);
    mavlink_msg_flexifunction_directory_ack_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flexifunction_directory_ack_pack(system_id, component_id, group_id, &msg , packet1.target_system , packet1.target_component , packet1.directory_type , packet1.start_index , packet1.count , packet1.result );
    mavlink_msg_flexifunction_directory_ack_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flexifunction_directory_ack_pack_chan(system_id, component_id, group_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component , packet1.directory_type , packet1.start_index , packet1.count , packet1.result );
    mavlink_msg_flexifunction_directory_ack_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_flexifunction_command(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
...
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flexifunction_command_encode(system_id, component_id, group_id, &msg, &packet1);
    mavlink_msg_flexifunction_command_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flexifunction_command_pack(system_id, component_id, group_id, &msg , packet1.target_system , packet1.target_component , packet1.command_type );
    mavlink_msg_flexifunction_command_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flexifunction_command_pack_chan(system_id, component_id, group_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component , packet1.command_type );
    mavlink_msg_flexifunction_command_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_flexifunction_command_ack(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
...
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flexifunction_command_ack_encode(system_id, component_id, group_id, &msg, &packet1);
    mavlink_msg_flexifunction_command_ack_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flexifunction_command_ack_pack(system_id, component_id, group_id, &msg , packet1.command_type , packet1.result );
    mavlink_msg_flexifunction_command_ack_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_flexifunction_command_ack_pack_chan(system_id, component_id, group_id, MAVLINK_COMM_0, &msg , packet1.command_type , packet1.result );
    mavlink_msg_flexifunction_command_ack_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_serial_udb_extra_f2_a(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
...
static void mavlink_test_serial_udb_extra_f2_b(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
...
static void mavlink_test_serial_udb_extra_f4(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
...
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f4_encode(system_id, component_id, group_id, &msg, &packet1);
    mavlink_msg_serial_udb_extra_f4_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f4_pack(system_id, component_id, group_id, &msg , packet1.sue_ROLL_STABILIZATION_AILERONS , packet1.sue_ROLL_STABILIZATION_RUDDER , packet1.sue_PITCH_STABILIZATION , packet1.sue_YAW_STABILIZATION_RUDDER , packet1.sue_YAW_STABILIZATION_AILERON , packet1.sue_AILERON_NAVIGATION , packet1.sue_RUDDER_NAVIGATION , packet1.sue_ALTITUDEHOLD_STABILIZED , packet1.sue_ALTITUDEHOLD_WAYPOINT , packet1.sue_RACING_MODE );
    mavlink_msg_serial_udb_extra_f4_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f4_pack_chan(system_id, component_id, group_id, MAVLINK_COMM_0, &msg , packet1.sue_ROLL_STABILIZATION_AILERONS , packet1.sue_ROLL_STABILIZATION_RUDDER , packet1.sue_PITCH_STABILIZATION , packet1.sue_YAW_STABILIZATION_RUDDER , packet1.sue_YAW_STABILIZATION_AILERON , packet1.sue_AILERON_NAVIGATION , packet1.sue_RUDDER_NAVIGATION , packet1.sue_ALTITUDEHOLD_STABILIZED , packet1.sue_ALTITUDEHOLD_WAYPOINT , packet1.sue_RACING_MODE );
    mavlink_msg_serial_udb_extra_f4_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_serial_udb_extra_f5(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
...
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f5_encode(system_id, component_id, group_id, &msg, &packet1);
    mavlink_msg_serial_udb_extra_f5_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f5_pack(system_id, component_id, group_id, &msg , packet1.sue_YAWKP_AILERON , packet1.sue_YAWKD_AILERON , packet1.sue_ROLLKP , packet1.sue_ROLLKD );
    mavlink_msg_serial_udb_extra_f5_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f5_pack_chan(system_id, component_id, group_id, MAVLINK_COMM_0, &msg , packet1.sue_YAWKP_AILERON , packet1.sue_YAWKD_AILERON , packet1.sue_ROLLKP , packet1.sue_ROLLKD );
    mavlink_msg_serial_udb_extra_f5_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_serial_udb_extra_f6(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
...
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f6_encode(system_id, component_id, group_id, &msg, &packet1);
    mavlink_msg_serial_udb_extra_f6_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f6_pack(system_id, component_id, group_id, &msg , packet1.sue_PITCHGAIN , packet1.sue_PITCHKD , packet1.sue_RUDDER_ELEV_MIX , packet1.sue_ROLL_ELEV_MIX , packet1.sue_ELEVATOR_BOOST );
    mavlink_msg_serial_udb_extra_f6_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f6_pack_chan(system_id, component_id, group_id, MAVLINK_COMM_0, &msg , packet1.sue_PITCHGAIN , packet1.sue_PITCHKD , packet1.sue_RUDDER_ELEV_MIX , packet1.sue_ROLL_ELEV_MIX , packet1.sue_ELEVATOR_BOOST );
    mavlink_msg_serial_udb_extra_f6_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_serial_udb_extra_f7(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
...
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f7_encode(system_id, component_id, group_id, &msg, &packet1);
    mavlink_msg_serial_udb_extra_f7_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f7_pack(system_id, component_id, group_id, &msg , packet1.sue_YAWKP_RUDDER , packet1.sue_YAWKD_RUDDER , packet1.sue_ROLLKP_RUDDER , packet1.sue_ROLLKD_RUDDER , packet1.sue_RUDDER_BOOST , packet1.sue_RTL_PITCH_DOWN );
    mavlink_msg_serial_udb_extra_f7_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f7_pack_chan(system_id, component_id, group_id, MAVLINK_COMM_0, &msg , packet1.sue_YAWKP_RUDDER , packet1.sue_YAWKD_RUDDER , packet1.sue_ROLLKP_RUDDER , packet1.sue_ROLLKD_RUDDER , packet1.sue_RUDDER_BOOST , packet1.sue_RTL_PITCH_DOWN );
    mavlink_msg_serial_udb_extra_f7_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_serial_udb_extra_f8(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
...
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f8_encode(system_id, component_id, group_id, &msg, &packet1);
    mavlink_msg_serial_udb_extra_f8_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f8_pack(system_id, component_id, group_id, &msg , packet1.sue_HEIGHT_TARGET_MAX , packet1.sue_HEIGHT_TARGET_MIN , packet1.sue_ALT_HOLD_THROTTLE_MIN , packet1.sue_ALT_HOLD_THROTTLE_MAX , packet1.sue_ALT_HOLD_PITCH_MIN , packet1.sue_ALT_HOLD_PITCH_MAX , packet1.sue_ALT_HOLD_PITCH_HIGH );
    mavlink_msg_serial_udb_extra_f8_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f8_pack_chan(system_id, component_id, group_id, MAVLINK_COMM_0, &msg , packet1.sue_HEIGHT_TARGET_MAX , packet1.sue_HEIGHT_TARGET_MIN , packet1.sue_ALT_HOLD_THROTTLE_MIN , packet1.sue_ALT_HOLD_THROTTLE_MAX , packet1.sue_ALT_HOLD_PITCH_MIN , packet1.sue_ALT_HOLD_PITCH_MAX , packet1.sue_ALT_HOLD_PITCH_HIGH );
    mavlink_msg_serial_udb_extra_f8_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_serial_udb_extra_f13(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
...
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f13_encode(system_id, component_id, group_id, &msg, &packet1);
    mavlink_msg_serial_udb_extra_f13_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f13_pack(system_id, component_id, group_id, &msg , packet1.sue_week_no , packet1.sue_lat_origin , packet1.sue_lon_origin , packet1.sue_alt_origin );
    mavlink_msg_serial_udb_extra_f13_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f13_pack_chan(system_id, component_id, group_id, MAVLINK_COMM_0, &msg , packet1.sue_week_no , packet1.sue_lat_origin , packet1.sue_lon_origin , packet1.sue_alt_origin );
    mavlink_msg_serial_udb_extra_f13_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_serial_udb_extra_f14(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
...
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f14_encode(system_id, component_id, group_id, &msg, &packet1);
    mavlink_msg_serial_udb_extra_f14_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f14_pack(system_id, component_id, group_id, &msg , packet1.sue_WIND_ESTIMATION , packet1.sue_GPS_TYPE , packet1.sue_DR , packet1.sue_BOARD_TYPE , packet1.sue_AIRFRAME , packet1.sue_RCON , packet1.sue_TRAP_FLAGS , packet1.sue_TRAP_SOURCE , packet1.sue_osc_fail_count , packet1.sue_CLOCK_CONFIG , packet1.sue_FLIGHT_PLAN_TYPE );
    mavlink_msg_serial_udb_extra_f14_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f14_pack_chan(system_id, component_id, group_id, MAVLINK_COMM_0, &msg , packet1.sue_WIND_ESTIMATION , packet1.sue_GPS_TYPE , packet1.sue_DR , packet1.sue_BOARD_TYPE , packet1.sue_AIRFRAME , packet1.sue_RCON , packet1.sue_TRAP_FLAGS , packet1.sue_TRAP_SOURCE , packet1.sue_osc_fail_count , packet1.sue_CLOCK_CONFIG , packet1.sue_FLIGHT_PLAN_TYPE );
    mavlink_msg_serial_udb_extra_f14_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_serial_udb_extra_f15(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
...
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f15_encode(system_id, component_id, group_id, &msg, &packet1);
    mavlink_msg_serial_udb_extra_f15_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f15_pack(system_id, component_id, group_id, &msg , packet1.sue_ID_VEHICLE_MODEL_NAME , packet1.sue_ID_VEHICLE_REGISTRATION );
    mavlink_msg_serial_udb_extra_f15_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f15_pack_chan(system_id, component_id, group_id, MAVLINK_COMM_0, &msg , packet1.sue_ID_VEHICLE_MODEL_NAME , packet1.sue_ID_VEHICLE_REGISTRATION );
    mavlink_msg_serial_udb_extra_f15_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_serial_udb_extra_f16(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
...
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f16_encode(system_id, component_id, group_id, &msg, &packet1);
    mavlink_msg_serial_udb_extra_f16_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f16_pack(system_id, component_id, group_id, &msg , packet1.sue_ID_LEAD_PILOT , packet1.sue_ID_DIY_DRONES_URL );
    mavlink_msg_serial_udb_extra_f16_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f16_pack_chan(system_id, component_id, group_id, MAVLINK_COMM_0, &msg , packet1.sue_ID_LEAD_PILOT , packet1.sue_ID_DIY_DRONES_URL );
    mavlink_msg_serial_udb_extra_f16_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_altitudes(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
...
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_altitudes_encode(system_id, component_id, group_id, &msg, &packet1);
    mavlink_msg_altitudes_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_altitudes_pack(system_id, component_id, group_id, &msg , packet1.time_boot_ms , packet1.alt_gps , packet1.alt_imu , packet1.alt_barometric , packet1.alt_optical_flow , packet1.alt_range_finder , packet1.alt_extra );
    mavlink_msg_altitudes_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_altitudes_pack_chan(system_id, component_id, group_id, MAVLINK_COMM_0, &msg , packet1.time_boot_ms , packet1.alt_gps , packet1.alt_imu , packet1.alt_barometric , packet1.alt_optical_flow , packet1.alt_range_finder , packet1.alt_extra );
    mavlink_msg_altitudes_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_airspeeds(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
...
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_airspeeds_encode(system_id, component_id, group_id, &msg, &packet1);
    mavlink_msg_airspeeds_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_airspeeds_pack(system_id, component_id, group_id, &msg , packet1.time_boot_ms , packet1.airspeed_imu , packet1.airspeed_pitot , packet1.airspeed_hot_wire , packet1.airspeed_ultrasonic , packet1.aoa , packet1.aoy );
    mavlink_msg_airspeeds_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_airspeeds_pack_chan(system_id, component_id, group_id, MAVLINK_COMM_0, &msg , packet1.time_boot_ms , packet1.airspeed_imu , packet1.airspeed_pitot , packet1.airspeed_hot_wire , packet1.airspeed_ultrasonic , packet1.aoa , packet1.aoy );
    mavlink_msg_airspeeds_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_serial_udb_extra_f17(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
...
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f17_encode(system_id, component_id, group_id, &msg, &packet1);
    mavlink_msg_serial_udb_extra_f17_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f17_pack(system_id, component_id, group_id, &msg , packet1.sue_feed_forward , packet1.sue_turn_rate_nav , packet1.sue_turn_rate_fbw );
    mavlink_msg_serial_udb_extra_f17_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f17_pack_chan(system_id, component_id, group_id, MAVLINK_COMM_0, &msg , packet1.sue_feed_forward , packet1.sue_turn_rate_nav , packet1.sue_turn_rate_fbw );
    mavlink_msg_serial_udb_extra_f17_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_serial_udb_extra_f18(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
...
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f18_encode(system_id, component_id, group_id, &msg, &packet1);
    mavlink_msg_serial_udb_extra_f18_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f18_pack(system_id, component_id, group_id, &msg , packet1.angle_of_attack_normal , packet1.angle_of_attack_inverted , packet1.elevator_trim_normal , packet1.elevator_trim_inverted , packet1.reference_speed );
    mavlink_msg_serial_udb_extra_f18_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f18_pack_chan(system_id, component_id, group_id, MAVLINK_COMM_0, &msg , packet1.angle_of_attack_normal , packet1.angle_of_attack_inverted , packet1.elevator_trim_normal , packet1.elevator_trim_inverted , packet1.reference_speed );
    mavlink_msg_serial_udb_extra_f18_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_serial_udb_extra_f19(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
...
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f19_encode(system_id, component_id, group_id, &msg, &packet1);
    mavlink_msg_serial_udb_extra_f19_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f19_pack(system_id, component_id, group_id, &msg , packet1.sue_aileron_output_channel , packet1.sue_aileron_reversed , packet1.sue_elevator_output_channel , packet1.sue_elevator_reversed , packet1.sue_throttle_output_channel , packet1.sue_throttle_reversed , packet1.sue_rudder_output_channel , packet1.sue_rudder_reversed );
    mavlink_msg_serial_udb_extra_f19_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f19_pack_chan(system_id, component_id, group_id, MAVLINK_COMM_0, &msg , packet1.sue_aileron_output_channel , packet1.sue_aileron_reversed , packet1.sue_elevator_output_channel , packet1.sue_elevator_reversed , packet1.sue_throttle_output_channel , packet1.sue_throttle_reversed , packet1.sue_rudder_output_channel , packet1.sue_rudder_reversed );
    mavlink_msg_serial_udb_extra_f19_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_serial_udb_extra_f20(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
...
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f20_encode(system_id, component_id, group_id, &msg, &packet1);
    mavlink_msg_serial_udb_extra_f20_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f20_pack(system_id, component_id, group_id, &msg , packet1.sue_number_of_inputs , packet1.sue_trim_value_input_1 , packet1.sue_trim_value_input_2 , packet1.sue_trim_value_input_3 , packet1.sue_trim_value_input_4 , packet1.sue_trim_value_input_5 , packet1.sue_trim_value_input_6 , packet1.sue_trim_value_input_7 , packet1.sue_trim_value_input_8 , packet1.sue_trim_value_input_9 , packet1.sue_trim_value_input_10 , packet1.sue_trim_value_input_11 , packet1.sue_trim_value_input_12 );
    mavlink_msg_serial_udb_extra_f20_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f20_pack_chan(system_id, component_id, group_id, MAVLINK_COMM_0, &msg , packet1.sue_number_of_inputs , packet1.sue_trim_value_input_1 , packet1.sue_trim_value_input_2 , packet1.sue_trim_value_input_3 , packet1.sue_trim_value_input_4 , packet1.sue_trim_value_input_5 , packet1.sue_trim_value_input_6 , packet1.sue_trim_value_input_7 , packet1.sue_trim_value_input_8 , packet1.sue_trim_value_input_9 , packet1.sue_trim_value_input_10 , packet1.sue_trim_value_input_11 , packet1.sue_trim_value_input_12 );
    mavlink_msg_serial_udb_extra_f20_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_serial_udb_extra_f21(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
...
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f21_encode(system_id, component_id, group_id, &msg, &packet1);
    mavlink_msg_serial_udb_extra_f21_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f21_pack(system_id, component_id, group_id, &msg , packet1.sue_accel_x_offset , packet1.sue_accel_y_offset , packet1.sue_accel_z_offset , packet1.sue_gyro_x_offset , packet1.sue_gyro_y_offset , packet1.sue_gyro_z_offset );
    mavlink_msg_serial_udb_extra_f21_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f21_pack_chan(system_id, component_id, group_id, MAVLINK_COMM_0, &msg , packet1.sue_accel_x_offset , packet1.sue_accel_y_offset , packet1.sue_accel_z_offset , packet1.sue_gyro_x_offset , packet1.sue_gyro_y_offset , packet1.sue_gyro_z_offset );
    mavlink_msg_serial_udb_extra_f21_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_serial_udb_extra_f22(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
...
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f22_encode(system_id, component_id, group_id, &msg, &packet1);
    mavlink_msg_serial_udb_extra_f22_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f22_pack(system_id, component_id, group_id, &msg , packet1.sue_accel_x_at_calibration , packet1.sue_accel_y_at_calibration , packet1.sue_accel_z_at_calibration , packet1.sue_gyro_x_at_calibration , packet1.sue_gyro_y_at_calibration , packet1.sue_gyro_z_at_calibration );
    mavlink_msg_serial_udb_extra_f22_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_serial_udb_extra_f22_pack_chan(system_id, component_id, group_id, MAVLINK_COMM_0, &msg , packet1.sue_accel_x_at_calibration , packet1.sue_accel_y_at_calibration , packet1.sue_accel_z_at_calibration , packet1.sue_gyro_x_at_calibration , packet1.sue_gyro_y_at_calibration , packet1.sue_gyro_z_at_calibration );
    mavlink_msg_serial_udb_extra_f22_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_matrixpilot(uint8_t system_id, uint8_t component_id, uint8_t group_id, mavlink_message_t *last_msg)
{
    mavlink_test_flexifunction_set(system_id, component_id, group_id, last_msg);
    mavlink_test_flexifunction_read_req(system_id, component_id, group_id, last_msg);
    mavlink_test_flexifunction_buffer_function(system_id, component_id, group_id, last_msg);
    mavlink_test_flexifunction_buffer_function_ack(system_id, component_id, group_id, last_msg);
    mavlink_test_flexifunction_directory(system_id, component_id, group_id, last_msg);
    mavlink_test_flexifunction_directory_ack(system_id, component_id, group_id, last_msg);
    mavlink_test_flexifunction_command(system_id, component_id, group_id, last_msg);
    mavlink_test_flexifunction_command_ack(system_id, component_id, group_id, last_msg);
    mavlink_test_serial_udb_extra_f2_a(system_id, component_id, group_id, last_msg);
    mavlink_test_serial_udb_extra_f2_b(system_id, component_id, group_id, last_msg);
    mavlink_test_serial_udb_extra_f4(system_id, component_id, group_id, last_msg);
    mavlink_test_serial_udb_extra_f5(system_id, component_id, group_id, last_msg);
    mavlink_test_serial_udb_extra_f6(system_id, component_id, group_id, last_msg);
    mavlink_test_serial_udb_extra_f7(system_id, component_id, group_id, last_msg);
    mavlink_test_serial_udb_extra_f8(system_id, component_id, group_id, last_msg);
    mavlink_test_serial_udb_extra_f13(system_id, component_id, group_id, last_msg);
    mavlink_test_serial_udb_extra_f14(system_id, component_id, group_id, last_msg);
    mavlink_test_serial_udb_extra_f15(system_id, component_id, group_id, last_msg);
    mavlink_test_serial_udb_extra_f16(system_id, component_id, group_id, last_msg);
    mavlink_test_altitudes(system_id, component_id, group_id, last_msg);
    mavlink_test_airspeeds(system_id, component_id, group_id, last_msg);
    mavlink_test_serial_udb_extra_f17(system_id, component_id, group_id, last_msg);
    mavlink_test_serial_udb_extra_f18(system_id, component_id, group_id, last_msg);
    mavlink_test_serial_udb_extra_f19(system_id, component_id, group_id, last_msg);
    mavlink_test_serial_udb_extra_f20(system_id, component_id, group_id, last_msg);
    mavlink_test_serial_udb_extra_f21(system_id, component_id, group_id, last_msg);
    mavlink_test_serial_udb_extra_f22(system_id, component_id, group_id, last_msg);
}
